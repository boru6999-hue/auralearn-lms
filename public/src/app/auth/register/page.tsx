...
export default function RegisterPage() {
  ...
  const socialBtn: React.CSSProperties = {
    ...
    background: isDark ? colors.socialBg : "#333", border: `1px solid ${isDark ? colors.border : "#333"}`,
  ...
  const hoverOn = (e: React.MouseEvent<HTMLButtonElement>) => {
    // Both modes: white bg on hover, black text/logos
    e.currentTarget.style.background = "#fff";
    e.currentTarget.style.color = "#000";
    e.currentTarget.style.borderColor = "#fff";
    e.currentTarget.querySelectorAll("svg path").forEach((p: any) => {
      if (!p.dataset.orig) p.dataset.orig = p.getAttribute("fill") || "none";
