...
function ResetForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    else { const data = await res.json(); setError(data.error || "Алдаа гарлаа"); }
    setLoading(false);
  }

  const inputStyle = {
    width: "100%", height: "48px", background: "#0d0d0d",
  ...
  if (success) return (
    <div style={{ textAlign: "center", padding: "8px 0" }}>
      ...
      <h2 style={{ color: "#fff", fontWeight: 600, fontSize: "16px", margin: "0 0 8px" }}>Амжилттай шинэчлэгдлээ</h2>
      <p style={{ color: "#555", fontSize: "13px" }}>Нэвтрэх хуудас руу шилжиж байна...</p>
    </div>
  );
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        <div>
          <label style={{ display: "block", fontSize: "13px", color: "#777", marginBottom: "8px", fontWeight: 500 }}>Шинэ нууц үг</label>
        ...
        <div>
          <label style={{ display: "block", fontSize: "13px", color: "#777", marginBottom: "8px", fontWeight: 500 }}>Нууц үг давтах</label>
...
export default function ResetPasswordPage() {
  return (
    <div style={{
      minHeight: "100vh", backgroundImage: "url('/auth-bg.jpg')",
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: "20px", fontWeight: 600, margin: "0 0 8px", letterSpacing: "-0.3px" }}>Шинэ нууц үг</h1>
          <p style={{ color: "#555", fontSize: "13px", margin: 0 }}>Шинэ нууц үгээ оруулна уу</p>
        </div>
        <Suspense fallback={<div style={{ color: "#555", textAlign: "center", fontSize: "14px" }}>Ачааллаж байна...</div>}>
          <ResetForm />
        </Suspense>
      </div>
    </div>
